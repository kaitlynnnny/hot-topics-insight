...
2. [系统架构总览](#3-系统架构总览)
3. [数据从哪里来](#4-数据从哪里来)
4. [新闻如何被筛选和排序](#5-新闻如何被筛选和排序)
5. [AI 模型如何辩论](#6-ai-模型如何辩论)
6. [文件目录与职责说明](#7-文件目录与职责说明)
7. [如何运行本项目](#8-如何运行本项目)
8. [如何修改和扩展](#9-如何修改和扩展)
9. [常见问题与故障排除](#10-常见问题与故障排除)
10. [技术术语表](#11-技术术语表)
...
## 3.3 抓取流程（一键运行 arc_detailed.ps1 发生了什么）
